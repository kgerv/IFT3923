...
\begin{homeworkProblem}
    ...
    \begin{itemize}
        \item[\underline{Couverture des instructions}:] Tout ensemble de paires de nombres réels va permettre à chaque instruction d'être exécutée au moins une fois. Un jeu de test valide est donc: $T = \{(1234.56, 789)\}$\\
        ...
        \item[\underline{Couverture des conditions}:] Non aplicable puisqu'il n'y a pas de conditions dans cette méthode.\\
        \item[\underline{Couverture des i-chemins}:] Non aplicable puisqu'il n'y a pas de boucles dans cette méthode.\\
    \end{itemize}
